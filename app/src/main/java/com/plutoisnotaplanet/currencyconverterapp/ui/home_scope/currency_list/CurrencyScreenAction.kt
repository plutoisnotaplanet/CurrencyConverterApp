...
sealed class CurrencyScreenAction {
    ...
    data class SelectCurrency(val listType: CurrencyListType, val currency: Currency) : CurrencyScreenAction()

    data class ToggleFavorite(val currency: Currency) : CurrencyScreenAction()
